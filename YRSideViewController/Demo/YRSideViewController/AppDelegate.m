...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UINavigationController *rootNAV = [[UINavigationController alloc] initWithRootViewController:_sideViewController];

    _sideViewController.leftViewShowWidth = 150;
    _sideViewController.rightViewShowWidth = 100;
