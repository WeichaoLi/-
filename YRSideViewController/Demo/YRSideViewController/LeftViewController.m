...
- (IBAction)push:(id)sender {
    ...
    YRSideViewController *parentVC = (YRSideViewController *)self.parentViewController;
    UINavigationController *nav = parentVC.rootViewController;
    [parentVC hideSideViewController:YES];
    [nav pushViewController:viewC animated:YES];
